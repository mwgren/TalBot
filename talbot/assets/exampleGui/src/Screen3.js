...
constructor(props) {
   ...
   breakerOne = () => {
        ...
        const { furhat } = this.props; // Destructure furhat from props
            furhat.send({
            event_name: 'breakerOne', // Example event name
            data: 'breakerOne', // Data to be sent with the event
          });
      };
    ...
    breakerTwo = () => {
           ...
           const { furhat } = this.props; // Destructure furhat from props
               furhat.send({
               event_name: 'breakerTwo', // Example event name
               data: 'breakerTwo', // Data to be sent with the event
             });
         };
    ...
    breakerThree = () => {
               ...
               const { furhat } = this.props; // Destructure furhat from props
                   furhat.send({
                   event_name: 'breakerThree', // Example event name
                   data: 'breakerThree', // Data to be sent with the event
                 });
             };
    ...
    breakerFour = () => {
               ...
               const { furhat } = this.props; // Destructure furhat from props
                   furhat.send({
                   event_name: 'breakerFour', // Example event name
                   data: 'breakerFour', // Data to be sent with the event
                 });
             };
    ...
    return (
        <div>
            <div className="div">
                ...
                <div className="div-6">
                    <Button onClick={this.breakerOne} className="button-3">breaker 1</Button>
                    <Button onClick={this.breakerTwo} className="button-3">breaker 2</Button>
                    <Button onClick={this.breakerThree} className="button-3">breaker 3</Button>
                    <Button onClick={this.breakerFour} className="button-3">breaker 4</Button>
